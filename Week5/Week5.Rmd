...
```{r eval=TRUE}
#Import data
Countries<- read.csv("C:/Users/Kelle/OneDrive/Desktop/STA 553/Week5/countries_total.csv")
Income<-read.csv("C:/Users/Kelle/OneDrive/Desktop/STA 553/Week5/income_per_person.csv")
LifeExp<-read.csv("C:/Users/Kelle/OneDrive/Desktop/STA 553/Week5/life_expectancy_years.csv")
Population<-read.csv("C:/Users/Kelle/OneDrive/Desktop/STA 553/Week5/population_total.csv")
...
```{r eval=TRUE}
### Full Data Set
ggplot(FinalData, aes(x=Income, 
                      y=LifeExpectancy, 
                      size = Population, 
                      color = region)) +
  ggtitle("Plot of Life Expectency by Income by Year")+
  geom_point(aes(size=Population, ids = Country),
             show.legend = TRUE,
             alpha = 0.7)+
    labs(title = 'Year: {closest_state}',
